...
# ==========================================
# atp_cycle.gd — the helicase's cofactor-activation lens (ATPCycleDesign.md)
#
...
# ---------- GLYPH IDENTITY (ThemeManager "ATP Cycle" group) ----------
...
## called it atp_fade_duration, which would have invited someone to pass it a
