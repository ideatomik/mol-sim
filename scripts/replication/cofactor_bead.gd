class_name CofactorBead
extends Node2D

# ==========================================
# cofactor_bead.gd
# ONE bead of the ATP/ADP/AMP/Pi glyph family — an adenine head or a single
# phosphate. Pooled: `helicase_atp_cycle.gd` creates a fixed set at build time and
...
# is pushed in by the owner (helicase_atp_cycle.gd, which is itself pushed by
